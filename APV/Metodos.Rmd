...
## Crecimientos mercado 
```{r}
bmi_est<-data.frame("GROSS INSURANCE PREMIUMS (USDbn)" = c(9.52,10.89,11.17,10.17,11.31,12.4,13.3,14.34),
                    "YoY" = c(8.1, 14.4, 2.6, -8.9, 11.3, 9.6, 7.2, 7.8),
                    "Y" = c(2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019))
...
ggplot(bmi_est,
  ...
  theme_eem_white()+
  scale_fill_eem(20)+
  labs(title = "Crecimiento Estimado Mercado",
       x = "Año",
       y = "Tasa (%)")
